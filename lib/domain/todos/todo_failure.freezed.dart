...
/// @nodoc
class __$UnexpectedCopyWithImpl<$Res> extends _$TodoFailureCopyWithImpl<$Res>
...
class _$_InsufficientPermission implements _InsufficientPermission {
  ...
  @override
  String toString() {
    return 'TodoFailure.insufficientPermission()';
  }
...
abstract class _InsufficientPermission implements TodoFailure {
...
class _$_UnableToUpdate implements _UnableToUpdate {
  ...
  @override
  String toString() {
    return 'TodoFailure.unableToUpdate()';
  }
...
abstract class _UnableToUpdate implements TodoFailure {
